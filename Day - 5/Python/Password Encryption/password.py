...
Label(root, text ='Encrpyting and Decrypting', font = 'arial 20 bold').pack()
Label(root, text ='Ashwin R', font = 'arial 20 bold').pack(side =BOTTOM)
...
Button(root, font = 'arial 10 bold', text = 'Result'  ,padx =2,bg ='Yellow' ,command = Mode).place(x=60, y = 150)
